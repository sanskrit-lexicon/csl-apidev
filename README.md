...
_Created: 06-08-2018 · Last updated: 05-09-2026_
...
API endpoint docs live in [`doc/`](https://github.com/sanskrit-lexicon/csl-apidev/blob/main/doc/readme.md). Of note:
...
- **Salt API** — a [C-SALT](https://api.c-salt.uni-koeln.de)-compatible REST + GraphQL
  ...
  [`salt_entries`](https://github.com/sanskrit-lexicon/csl-apidev/blob/main/doc/salt_entries.md), [`salt_ids`](https://github.com/sanskrit-lexicon/csl-apidev/blob/main/doc/salt_ids.md),
  [`salt_graphql`](https://github.com/sanskrit-lexicon/csl-apidev/blob/main/doc/salt_graphql.md), [`salt_multidict`](https://github.com/sanskrit-lexicon/csl-apidev/blob/main/doc/salt_multidict.md); Phase 1 controller skeleton in
...
- [Clean-URL permalinks roadmap](https://github.com/sanskrit-lexicon/csl-apidev/blob/main/doc/cleanurl.md) — path-based direct links to
...
The Salt API's live entry-point is [`api1/salt_entries.php`](https://github.com/sanskrit-lexicon/csl-apidev/blob/main/api1/salt_entries.php),
documented in [`doc/salt_entries.md`](https://github.com/sanskrit-lexicon/csl-apidev/blob/main/doc/salt_entries.md). A real,
...
(see the handler in [`api1/salt_entries.php`](https://github.com/sanskrit-lexicon/csl-apidev/blob/main/api1/salt_entries.php) lines 15–18).
...
See [CLAUDE.md](https://github.com/sanskrit-lexicon/csl-apidev/blob/main/CLAUDE.md) for full definitions.
