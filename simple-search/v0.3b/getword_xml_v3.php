...
dbgprint($dbg,"Entering getword_xml_v3.php 1\n");
require_once('simple_search.php');
dbgprint($dbg,"Entering getword_xml_v3.php 2\n");
require_once('dalnorm.php');
dbgprint($dbg,"Entering getword_xml_v3.php 3\n");
require_once($dirpfx . "parm.php");
$getParms = new Parm();
dbgprint($dbg,"Entering getword_xml_v3.php 4\n");
