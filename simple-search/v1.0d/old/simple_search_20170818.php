...
class Simple_Search{
 ...
 public function ngram_initialilze(){
  $this->ngram2_check = new Ngram_Check(2,"../ngram0/ngram_2.txt");
  $this->ngram3_check = new Ngram_Check(3,"../ngram0/ngram_3.txt");
  // beginning ngrams
  $this->ngram2beg_check = new Ngram_Check(2,"../ngram0/ngram_2_beg.txt");
  $this->ngram3beg_check = new Ngram_Check(3,"../ngram0/ngram_3_beg.txt");
 }
