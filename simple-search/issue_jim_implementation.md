...
The PHP engine in [simple-search/v1.1/](https://github.com/sanskrit-lexicon/csl-apidev/tree/main/simple-search/v1.1) is **frozen**; all code work below is
new. Everything marked **(data ready)** is already built and committed — only
the wiring is yours.

## Specs (read these for detail)
- Engine fixes A–I, milestones M1–M5, questions Q1–Q13 → [simple-search/roadmap_v1.2.md](https://github.com/sanskrit-lexicon/csl-apidev/blob/main/simple-search/roadmap_v1.2.md)
- DH streams A–D, questions → [simple-search/roadmap_dh.md](https://github.com/sanskrit-lexicon/csl-apidev/blob/main/simple-search/roadmap_dh.md)
- Engine overview + worked examples → [simple-search/readme.org](https://github.com/sanskrit-lexicon/csl-apidev/blob/main/simple-search/readme.org)
- Measurement/gate → [simple-search/eval/readme.md](https://github.com/sanskrit-lexicon/csl-apidev/blob/main/simple-search/eval/readme.md)
...
## Phase 1 — M1 engine hygiene  ([roadmap_v1.2 §§4, 7, 8](https://github.com/sanskrit-lexicon/csl-apidev/blob/main/simple-search/roadmap_v1.2.md))
...
## Phase 2 — M2 ranking (the headline fix)  ([roadmap_v1.2 §5](https://github.com/sanskrit-lexicon/csl-apidev/blob/main/simple-search/roadmap_v1.2.md))
...
## Phase 3 — M3 precision  ([roadmap_v1.2 §§6, 9](https://github.com/sanskrit-lexicon/csl-apidev/blob/main/simple-search/roadmap_v1.2.md))
...
## Phase 4 — M4 input coverage  ([roadmap_v1.2 §§8, 10](https://github.com/sanskrit-lexicon/csl-apidev/blob/main/simple-search/roadmap_v1.2.md))
...
## Phase 5 — M5 scale (optional)  ([roadmap_v1.2 §11](https://github.com/sanskrit-lexicon/csl-apidev/blob/main/simple-search/roadmap_v1.2.md))
- [ ] **Fix H** — index-side "blur-key" retrieval (the [simple-search/simpleslp/](https://github.com/sanskrit-lexicon/csl-apidev/tree/main/simple-search/simpleslp) machinery is the base).

## DH streams  ([roadmap_dh.md](https://github.com/sanskrit-lexicon/csl-apidev/blob/main/simple-search/roadmap_dh.md))
...
- [ ] **Stream B — corpus-grounding** (`corpus=yes`): DCS frequency + genre + examples
  per result. **Join key ready** → [simple-search/dcs_xref/dcs_cdsl_xref.tsv](https://github.com/sanskrit-lexicon/csl-apidev/blob/main/simple-search/dcs_xref/dcs_cdsl_xref.tsv)
...
- [x] **Stream D — measured quality**: [simple-search/eval/](https://github.com/sanskrit-lexicon/csl-apidev/tree/main/simple-search/eval) (done; your job is to keep
  the gate green and grow the gold set — see Q D1/D2/D3).

---

## Questions for you to resolve
**Engine ([roadmap_v1.2 §15](https://github.com/sanskrit-lexicon/csl-apidev/blob/main/simple-search/roadmap_v1.2.md)):**
...
4. OK to add `score` to the JSON contract (consumers: [list-0.2s_rw.php](https://github.com/sanskrit-lexicon/csl-apidev/blob/main/simple-search/v1.1/list-0.2s_rw.php), sanlex-vue)?
...
**DH ([roadmap_dh.md §8](https://github.com/sanskrit-lexicon/csl-apidev/blob/main/simple-search/roadmap_dh.md)):**
...
- Boundary sub-question: who owns the DCS↔CDSL crosswalk (now in [simple-search/dcs_xref/](https://github.com/sanskrit-lexicon/csl-apidev/tree/main/simple-search/dcs_xref))?

## Where everything is
| What | Path | State |
|---|---|---|
| Engine (frozen) | [simple-search/v1.1/](https://github.com/sanskrit-lexicon/csl-apidev/tree/main/simple-search/v1.1) | reference |
| v1.2 spec | [simple-search/roadmap_v1.2.md](https://github.com/sanskrit-lexicon/csl-apidev/blob/main/simple-search/roadmap_v1.2.md) | ready |
| DH spec | [simple-search/roadmap_dh.md](https://github.com/sanskrit-lexicon/csl-apidev/blob/main/simple-search/roadmap_dh.md) | ready |
| Refreshed frequencies | [simple-search/wf1/wf.txt](https://github.com/sanskrit-lexicon/csl-apidev/blob/main/simple-search/wf1/wf.txt) | **data ready, unwired** |
