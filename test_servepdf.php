...
Parameters:
 ...
 08-02-2017  Rewrite so that all output is gathered into a string,
    and then the string is written.
    Done so that also the string may be written via dbgprint
*/
$dict = $_GET['dict'];
$page = $_GET['page'];
...
if ($imageParm) {  
 // for images
 $imgOrpdf="<img src='$pdf' $imageParm />";
}else { 
 // for pdfs
 $imgOrpdf = "<object id='servepdf' type='application/pdf' data='$pdf'" .
  "style='width: 98%; height:98%'></object>";
}

$curdir = "http://www.sanskrit-lexicon.uni-koeln.de/scans/awork/apidev";
$htmlstr = <<<EOD
<html>
<head>
<META HTTP-EQUIV="Content-Type" CONTENT="text/html; charset=utf-8">
<title> $dictupper Cologne Scan</title>
<link rel='stylesheet' type='text/css' href='$curdir/css/serveimg.css' />
</head>
$imgOrpdf
<div id='pagenav'>
<a href="$curdir/test_servepdf.php?dict=$dict&page=$pageprev" 
   class='nppage'><span class='nppage1'>&lt;</span>&nbsp;</a>
<a href="$curdir/test_servepdf.php?dict=$dict&page=$pagenext" 
   class='nppage'><span class='nppage1'>&gt;</span>&nbsp;</a>
</div>
</body>
</html>
